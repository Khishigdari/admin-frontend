  ...
  return (
    <div className="bg-white w-1/6 h-screen mr-6 py-9 px-5 flex flex-col items-center">
      ...
      <div className="flex flex-col items-center">
        <Link href="./products">
          <button className="btn btn-ghost focus:btn-neutral px-6 rounded-full flex gap-[10px] mb-6">
            <LayoutDashboard /> Food menu
          </button>
        </Link>
        <a href="./orders">
          <button className="flex gap-[10px] w-full px-6 rounded-full btn btn-ghost active:btn-neutral">
            <Truck /> Orders
          </button>
        </a>
      </div>
